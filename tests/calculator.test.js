...
assert(testPerformCalculation("3+5*2-1") === 12, "Tes Urutan Operasi");
assert(testPerformCalculation("1/0") === 'Error', "Tes Pembagian dengan Nol");
assert(testPerformCalculation("10/4") === 2.5, "Tes Pembagian Desimal");
assert(testPerformCalculation("sqrt(4)") === 'Error', "Tes Fungsi Tidak Valid");

console.log(`--- Tes Unit Selesai ---\nTotal: ${testsPassed + testsFailed}, Lulus: ${testsPassed}, Gagal: ${testsFailed}`);

if (testsFailed > 0) {
  console.error("🔴 Beberapa tes gagal!");
} else {
